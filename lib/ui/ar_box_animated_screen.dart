...
class ARBoxAnimated extends StatefulWidget {
  const ARBoxAnimated({Key? key}) : super(key: key);

  @override
  _ARBoxAnimatedState createState() => _ARBoxAnimatedState();
}

class _ARBoxAnimatedState extends State<ARBoxAnimated> {
