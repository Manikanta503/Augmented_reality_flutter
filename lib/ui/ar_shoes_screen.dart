...
class ARShoes extends StatefulWidget {
  const ARShoes({Key? key}) : super(key: key);

  @override
  _ARShoesState createState() => _ARShoesState();
}

class _ARShoesState extends State<ARShoes> {
